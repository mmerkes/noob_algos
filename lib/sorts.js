module.exports = (function() {
  ...
  */
  ...
  /*
    Algorithm SortByShell(s, firstPosition, lastPosition)
    -----------------------------------------------------
    Set gap size to (size of sequence)/2
    while gap size > 0
        Sort all subsequences determined by gap size by insertion sort
        Set gap size to (gap size) / 2
    endwhile
  */
